(function () {
    ...
    var localizedTextsRu = function (localizedTexts) {
        localizedTexts['ru'] = {
            ...
            'news.type.catalog.warning': 'Предупреждение',
            'news.type.catalog.danger': 'Опасность',
            ...
            // todo это косяк
            'EACH_DAY': 'Каждый день',
            'EACH_TWO_DAYS': 'Каждый месяц',
            'EACH_THREE_DAYS': 'Каждые три дня',
            'EACH_WEEKDAY': 'Каждые два дня',
            'EACH_WEEK': 'По будням',
            'EACH_MONTH': 'Раз в неделю',
            'EACH_YEAR': 'Раз в год',
